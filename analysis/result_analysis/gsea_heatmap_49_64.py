...
for age in [49, 64]:
    df = pd.read_csv(f'{OUTPUT_DIR}/gsea_results_{age}.csv')
    ...
    plt.savefig(f'output/result_analysis/ukb_MixtureGRBF_cv_nsubtype_biom17/5_subtypes/gsea_heatmap_{age}.png', dpi=300, bbox_inches='tight', facecolor='white')
    plt.close()

    print(f'Figure saved to {f"output/result_analysis/ukb_MixtureGRBF_cv_nsubtype_biom17/5_subtypes/gsea_heatmap_{age}.png"}')