...
fig, ax = plt.subplots(figsize=(18/2.54, 4/2.54))
...
result_df = pd.read_csv(f'output/result_analysis/{exp_name}/{nsubtype}_subtypes/cf_difference.csv')
...
output_path = f'output/result_analysis/{exp_name}/{nsubtype}_subtypes/cf_difference.png'
